...
void goToGame() {
    ...
    DMANow(3, topScrnPal, ((unsigned short *)0x5000000), 512/2);
    (*(volatile unsigned short*)0x400000C) = ((0)<<2) | ((25)<<8) | (0<<7) | (2<<14);
    DMANow(3, gamescrnTiles, &((charblock *)0x6000000)[0], 1408/2);
    DMANow(3, gamescrnMap, &((screenblock *)0x6000000)[25], 4096/2);
