...
void goToStart() {
    fillScreen(((31) | (10)<<5 | (0)<<10));

    drawString(80, 60, "WELCOME to Breakout", 0);
    drawString(89, 60, "To play, hit start.", 0);
...
void goToGame() {
    ...
    drawString(150, 1, "Bricks Remaining: ", ((31) | (31)<<5 | (31)<<10));
...
void game() {
    ...
    drawRect(150, 107, 8, 6, 0);
    drawRect(150, 113, 8, 6, 0);
    drawString(150, 107, buffer, ((31) | (31)<<5 | (31)<<10));
...
void goToPause() {
    ...
    fillScreen(((20) | (25)<<5 | (31)<<10));

    sprintf(buffer, "%d", bricksRemaining);

    drawString(70, 100, "Pause", ((31) | (31)<<5 | (31)<<10));

    drawString(80, 40, "Bricks remaining in game: ", ((31) | (31)<<5 | (31)<<10));

    drawRect(80, 196, 8, 6, ((20) | (25)<<5 | (31)<<10));
    drawRect(80, 202, 8, 6, ((20) | (25)<<5 | (31)<<10));
    drawString(80, 196, buffer, ((31) | (31)<<5 | (31)<<10));

    drawString(90, 60, "To resume, hit start", ((31) | (31)<<5 | (31)<<10));
...
void goToWin() {
    fillScreen(((16) | (31)<<5 | (16)<<10));

    drawString(80, 100, "YOU WON!", ((31) | (31)<<5 | (31)<<10));
    drawString(89, 40, "To play again, hit start.", ((31) | (31)<<5 | (31)<<10));
...
void goToLose() {
    ...
    drawString(80, 70, "YOU LOST! wild.", ((31) | (31)<<5 | (31)<<10));
    drawString(89, 40, "To play again, hit start.", ((31) | (31)<<5 | (31)<<10));
