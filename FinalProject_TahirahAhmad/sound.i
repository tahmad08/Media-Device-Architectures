...
void setupSounds();
void playSoundA( const unsigned char* sound,
 int length, int frequency, int loops);
void playSoundB( const unsigned char* sound,
 int length, int frequency, int loops);
...
void playSoundA( const unsigned char* sound,
 int length, int frequency, int loops) {
        ...
        DMANow(1, sound, (u16*)0x040000A0, (2 << 21) |
         (3 << 28) | (1 << 25) | (1 << 26));
...
void playSoundB( const unsigned char* sound, int length,
 int frequency, int loops) {

        dma[2].cnt = 0;

        int ticks = (16777216)/frequency;

        DMANow(2, sound, (u16*)0x040000A4, (2 << 21) |
         (3 << 28) | (1 << 25) | (1 << 26));
